...
const MigTigCables = () => {
  ...
  return (
    <>
    <Helmet>
        <title>Manufacturer of Mig Tig Cables- Viral Electronics - Nashik</title>
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      >
        <div className="container mx-auto px-4 md:px-6 -mt-64 sm:mt-0">
          <div className="max-w-3xl">
            ...
            >
              Premium MIG/TIG/CO2 (COAX) Welding Torch Cables
            </motion.h1>
            <motion.p 
            ...
            >
              High-Flexibility, Heat/Oil Resistant | IS 8130:1984 & IS 6380:1984 Compliant
            </motion.p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <ScrollAnimation direction="left">
              <div className="space-y-6">
                <div className="relative overflow-hidden rounded-lg shadow-lg">
                  <img
                    src="https://res.cloudinary.com/dex1t9dm2/image/upload/v1753377217/mig1_zocmig.png"
                    alt="MIG/TIG Welding Cable"
                    className="w-full h-auto cursor-zoom-in"
                    onClick={() => setSelectedImage("https://res.cloudinary.com/dex1t9dm2/image/upload/v1753377217/mig1_zocmig.png")}
                  />
                  <button
                ...
                <div className="grid grid-cols-3 gap-4">
                  <img
                    src="https://res.cloudinary.com/dex1t9dm2/image/upload/v1753377219/mig2_fqmpg8.png"
                    alt="Cable Close-up"
                    className="rounded-lg shadow-md cursor-pointer hover:opacity-90 transition-opacity h-32 object-cover"
                    onClick={() => setSelectedImage("https://res.cloudinary.com/dex1t9dm2/image/upload/v1753377219/mig2_fqmpg8.png")}
                  />
                  <img
                    src="https://res.cloudinary.com/dex1t9dm2/image/upload/v1753377216/mig3_r1snrh.png"
                    alt="Cable Manufacturing"
                    className="rounded-lg shadow-md cursor-pointer hover:opacity-90 transition-opacity h-32 object-cover"
                    onClick={() => setSelectedImage("https://res.cloudinary.com/dex1t9dm2/image/upload/v1753377216/mig3_r1snrh.png")}
                  />
                  <img
                    src="https://res.cloudinary.com/dex1t9dm2/image/upload/v1753377217/mig1_zocmig.png"
                    alt="Quality Testing"
            ...
            <ScrollAnimation direction="right" delay={0.2}>
              <div>
                <h2 className="text-3xl font-bold text-navy-900 mb-8 text-center">MIG/TIG/CO2 (COAX) Welding Torch Cables</h2>
                <p className="text-gray-700 mb-6">
                We at Viral Electronics manufacture Mig Tig Co2 Coax Torch Welding cables for general service normal duty elastomeric compound and HOFR for use in the welding industry i.e. namely in Mig Tig Co2 Coax welding equipments. We manufacture cables from 16 Sq.mm to 95 Sq.mm.
                </p>
                <div className="space-y-4 mb-8">
                  ...
                  <ul className="space-y-3">
                    <li className="flex items-start">
                      ...
                      <span>In Welding Industry, Fabrication Industry, Automotive Industry.</span>
                    </li>
                  </ul>
                </div>
                <div className="space-y-4 mb-8">
                  <h3 className="text-xl font-semibold text-navy-900">Specfications</h3>
                  <ul className="space-y-3">
                    <li className="flex items-start">
                      <span className="text-red-600 mr-2">•</span>
                      <span>Conductors  : The conductors shall be composed of plain or tinned plated annealed high conductivity copper wires complying with IS 8130:1984.</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-red-600 mr-2">•</span>
                      <span>Covering  : The general service normal duty elastomeric compound shall be Type SE 1 confirming to the requirements of IS 6380:1984. The heat resisting, oil resisting normal duty elastomeric compound shall be Type SE 3 confirming to the requirements of IS 6380: 1984.</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-red-600 mr-2">•</span>
                      <span>Cooling  : Air cooled</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-red-600 mr-2">•</span>
                ...
                <table className="w-full border-collapse">
                  <thead>
                    <tr className="bg-gray-100">
                      ...
                      <th className='border px-4 py-2 text-center' colSpan={5}>Current Rating at a Maximum Duty Cycle of</th>
                    </tr>
                    <tr className="bg-gray-100">
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4 md:px-6">
          <ScrollAnimation direction="up">
            <h2 className="text-3xl font-bold text-navy-900 mb-8 text-center">Current Rating of HOFR Normal Duty Elastomeric Compound Covered Cable with Copper Conductor</h2>
            <p className="text-base sm:text-lg md:text-xl text-gray-700 text-center mb-8 max-w-4xl mx-auto px-4">The following are typical duty cycles for various welding processes and applications</p>
          </ScrollAnimation>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <ScrollAnimation direction="left" delay={0.1}>
      ...
      {showChat && (
        ...
        >
          <div className="flex justify-between items-center mb-4">
            <h4 className="font-semibold">Ask an Expert</h4>
            <button
