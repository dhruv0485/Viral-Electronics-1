...
const StandardTpeCables = () => {
  ...
  return (
    <>
    <Helmet>
        <title>Manufacturer of Standard TPE Cables- Viral Electronics - Nashik</title>
      ...
      >
        <div className="container mx-auto px-4 md:px-6 -mt-64 sm:mt-0">
          <div className="max-w-3xl">
            ...
            >
              Standard Thermoplastic Elastomeric (TPE) Battery Cables
            </motion.h1>
            <motion.p 
            ...
            >
              Oil/Acid Resistant | Extreme Flexibility | IS 8130:1984 & IS 6380:1984 Certified
            </motion.p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <ScrollAnimation direction="left">
              <div className="space-y-6">
                <div className="relative overflow-hidden rounded-lg shadow-lg">
                  <img
                    src="https://res.cloudinary.com/dex1t9dm2/image/upload/v1753377247/stpe1_bnqilb.png"
                    alt="TPE Battery Cable"
                    className="w-full h-auto cursor-zoom-in"
                    onClick={() => setSelectedImage("https://res.cloudinary.com/dex1t9dm2/image/upload/v1753377247/stpe1_bnqilb.png")}
                  />
                  <button
                ...
                <div className="grid grid-cols-3 gap-4">
                  <img
                    src="https://res.cloudinary.com/dex1t9dm2/image/upload/v1753377243/stpe2_o7pbtk.png"
                    alt="Cable Close-up"
                    className="rounded-lg shadow-md cursor-pointer hover:opacity-90 transition-opacity h-32 object-cover"
                    onClick={() => setSelectedImage("https://res.cloudinary.com/dex1t9dm2/image/upload/v1753377243/stpe2_o7pbtk.png")}
                  />
                  <img
                    src="https://res.cloudinary.com/dex1t9dm2/image/upload/v1753377248/stpe3_amo6ik.png"
                    alt="Cable Manufacturing"
                    className="rounded-lg shadow-md cursor-pointer hover:opacity-90 transition-opacity h-32 object-cover"
                    onClick={() => setSelectedImage("https://res.cloudinary.com/dex1t9dm2/image/upload/v1753377248/stpe3_amo6ik.png")}
                  />
                  <img
                    src="https://res.cloudinary.com/dex1t9dm2/image/upload/v1753377247/stpe1_bnqilb.png"
                    alt="Quality Testing"
            ...
            <ScrollAnimation direction="right" delay={0.2}>
              <div>
                <h2 className="text-3xl font-bold text-navy-900 mb-8 text-center">Standard TPE Insulated Battery Cables</h2>
                <p className="text-gray-700 mb-6">
                We at Viral Electronics manufacture Standard Battery Cables used for Battery Charging units in battery industries, as connectors for 2 volt traction batteries industries, railways, Traction Forklift Charger, Solar Batteries. We manufacture cables from 1.00 sq.mm to 400 sq.mm.
                </p>
...
export default StandardTpeCables;